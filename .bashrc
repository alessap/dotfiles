...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/home/alessap/anaconda3/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
    if [ -f "/home/alessap/anaconda3/etc/profile.d/conda.sh" ]; then
# . "/home/alessap/anaconda3/etc/profile.d/conda.sh"  # commented out by conda initialize
...
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/alessap/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/alessap/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/alessap/miniconda3/etc/profile.d/conda.sh"
    else
